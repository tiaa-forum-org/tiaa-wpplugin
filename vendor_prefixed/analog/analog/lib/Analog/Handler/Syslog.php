...
class Syslog {
	public static $levels = array (
		\TIAAPlugin\Analog\Analog::DEBUG    => LOG_DEBUG,
		\TIAAPlugin\Analog\Analog::INFO     => LOG_INFO,
		\TIAAPlugin\Analog\Analog::NOTICE   => LOG_NOTICE,
		\TIAAPlugin\Analog\Analog::WARNING  => LOG_WARNING,
		\TIAAPlugin\Analog\Analog::ERROR    => LOG_ERR,
		\TIAAPlugin\Analog\Analog::CRITICAL => LOG_CRIT,
		\TIAAPlugin\Analog\Analog::ALERT    => LOG_ALERT,
		\TIAAPlugin\Analog\Analog::URGENT   => LOG_EMERG
	);
